"""Configuration helpers for ResearchSummaryAgency."""
...
DEFAULT_PROMPT_PATH = PROJECT_ROOT / "prompts" / "research_summary_agency_prompt.txt"
DEFAULT_KEY_PATH = PROJECT_ROOT / "secrets" / "llm_api_key.txt"
API_KEY_ENV_VAR = "RESEARCH_SUMMARY_AGENCY_API_KEY"
