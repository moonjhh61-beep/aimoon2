"""Configuration helpers for ResearchRunnerAgency."""
...
DEFAULT_PROMPT_PATH = PROJECT_ROOT / "prompts" / "research_runner_agency_prompt.txt"
DEFAULT_KEY_PATH = PROJECT_ROOT / "secrets" / "llm_api_key.txt"
API_KEY_ENV_VAR = "RESEARCH_RUNNER_AGENCY_API_KEY"
